...
mysqli_query($db,"UPDATE product SET product_name='$name', price='$price',quantity='$quant',total='$total' WHERE product_id='$id'");
...
<tr>
<td ><b><font color='#663300'>Total<em>*</em></font></b></td>
<td><label>
